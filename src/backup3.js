            ...
            req.on("end") {
                ...
                db.getUser(payload.quote.user.nif, function (err, user) {
                    ...
                    if (typeof user == 'undefined' || user.length === 0) {
                        ...
                        console.log("payload.quoteId",payload.quoteId);
                    ...
                    //Teste
                     ...
                     db.getUser(payload.quote.user.nif, function (err, user) {
                         ...
                         console.log("DB Verification",user.quotes[1122334450])
                    ...
                    //console.log(insurance);
                    console.log('END PAYLOAD', payload.quoteId);
                    console.log('END PAYLOAD2', teste);

                    res.end(JSON.stringify(teste));
                    console.log('END PAYLOAD3',teste);
                })
